    ...
    def generate_plan(
        ...
        plan = ActionPlan(
            ...
            steps=[
                ...
                ActionStep(
                    description="Allocate 10% to emergency fund", dependencies=[]
                ),
            ],
        )
...
class SimulationRequestService:
    ...
    def request_simulation(
        self, user_id: str, scenario: str, assumptions: Dict[str, Any]
    ) -> SimulationRequest:
        req = SimulationRequest(
            user_id=user_id, scenario_type=scenario, assumptions=assumptions
        )
