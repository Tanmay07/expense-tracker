...
from ai_copilot.infrastructure.repositories import GoalConversationRepository, BehaviorRepository
...
def test_copilot_routing(mock_completion):
    ...
    response = service.handle_message("user_1", "conv_1", "How do I pay off my car?", CopilotMode.DEBT_COACH)
