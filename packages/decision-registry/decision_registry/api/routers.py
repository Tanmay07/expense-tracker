...
@router.post("/decisions/{decision_id}/relationships", response_model=DecisionRelationship)
...
@router.get("/decisions/{decision_id}/relationships", response_model=List[DecisionRelationship])
