...
def get_artifact(
    artifact_id: str, repo: ArtifactRepository = Depends(get_artifact_repo)
):
...
def get_lineage(
    artifact_id: str, repo: ArtifactLineageRepository = Depends(get_lineage_repo)
):
