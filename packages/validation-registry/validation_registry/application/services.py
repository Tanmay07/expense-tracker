...
class ArtifactRegistryService:
    def __init__(self, repo: ArtifactRepository, storage: ArtifactStorageService, integrity: IntegrityService):
        self.repo = repo
        self.storage = storage
        self.integrity = integrity
        
    def register_artifact(self, dto: ArtifactRecordCreate, payload_bytes: bytes) -> ArtifactRecord:
...
class ArtifactLineageService:
    ...
    def link_artifacts(self, source_id: str, target_id: str, relationship_type: str) -> ArtifactLineage:
