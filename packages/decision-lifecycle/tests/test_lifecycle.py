...
def test_valid_state_transition():
    ...
    lifecycle = DecisionLifecycle(decision_id="dec_123", current_state=LifecycleState.GENERATED)
...
def test_invalid_state_transition():
    ...
    lifecycle = DecisionLifecycle(decision_id="dec_123", current_state=LifecycleState.DRAFT)
    mock_repo.get_by_decision_id.return_value = lifecycle
