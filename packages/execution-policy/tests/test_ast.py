...
def test_ast_evaluator_eq():
    ...
    ast_false = RuleAST(operator=RuleOperator.EQ, field="decision_metadata.amount", value=1000)
...
def test_ast_evaluator_gt():
    ...
    ast = RuleAST(operator=RuleOperator.GT, field="decision_metadata.amount", value=1000)
    assert ASTEvaluator.evaluate(ast, context) is True
...
def test_ast_evaluator_and():
    ...
    ast = RuleAST(
        ...
        conditions=[
            RuleAST(operator=RuleOperator.GT, field="decision_metadata.amount", value=1000),
