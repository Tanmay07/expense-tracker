...
class HierarchicalLearningSDK:
    ...
    def calculateConfidence(
        self, sample_size: int, evidence_quality: float, behavior_stability: float
    ) -> float:
    ...
    def resolveConsensus(
        self, household_id: str, conflict_topic: str, competing_preferences: dict
    ) -> dict:
        payload = {
