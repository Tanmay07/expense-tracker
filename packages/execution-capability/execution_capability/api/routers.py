...
from ..application.services import ExecutionCapabilityService, RoutingService, ApprovalService
...
def route_execution(
    req: RouteRequest,
    svc: RoutingService = Depends(get_routing_svc)
):
...
def request_approval(
    req: ApprovalPayload,
    svc: ApprovalService = Depends(get_approval_svc)
):
    return svc.request_approval(req.execution_step_id, req.capability_id, req.requested_by)
