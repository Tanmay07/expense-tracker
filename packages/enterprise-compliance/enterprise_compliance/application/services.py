...
class SuitabilityService:
    def __init__(
        self, repository: SuitabilityRepository, risk_repo: RiskProfileRepository
    ):
        self.repository = repository
        self.risk_repo = risk_repo

    def evaluate_suitability(
        self, user_id: str, investment_params: Dict[str, Any]
    ) -> SuitabilityProfile:
...
class ComplianceService:
    def __init__(
        self, policy_repo: PolicyRepository, decision_repo: DecisionRepository
    ):
        self.policy_repo = policy_repo
        self.decision_repo = decision_repo

    def evaluate_transaction(
        self, user_id: str, context_id: str, transaction_data: Dict[str, Any]
    ) -> EvaluationResult:
        ...
        for policy in policies:
            ...
            if (
                policy.name == "Maximum Crypto Exposure"
                and transaction_data.get("asset_class") == "CRYPTO"
            ):
