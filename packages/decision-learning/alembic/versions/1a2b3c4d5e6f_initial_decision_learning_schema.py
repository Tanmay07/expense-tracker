...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_decision_memory_decision_id'), 'decision_memory', ['decision_id'], unique=False)
    op.create_index(op.f('ix_decision_memory_user_id'), 'decision_memory', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_learning_patterns_user_id'), 'learning_patterns', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_adaptive_personalizations_id'), 'adaptive_personalizations', ['id'], unique=False)
    op.create_index(op.f('ix_adaptive_personalizations_user_id'), 'adaptive_personalizations', ['user_id'], unique=True)
    ...
    op.create_index(op.f('ix_policy_decision_cache_id'), 'policy_decision_cache', ['id'], unique=False)
    op.create_index(op.f('ix_policy_decision_cache_decision_id'), 'policy_decision_cache', ['decision_id'], unique=False)
    ...
    op.create_index(op.f('ix_decision_predictions_id'), 'decision_predictions', ['id'], unique=False)
    op.create_index(op.f('ix_decision_predictions_decision_id'), 'decision_predictions', ['decision_id'], unique=False)
    op.create_index(op.f('ix_decision_predictions_user_id'), 'decision_predictions', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_financial_dna_profiles_id'), 'financial_dna_profiles', ['id'], unique=False)
    op.create_index(op.f('ix_financial_dna_profiles_user_id'), 'financial_dna_profiles', ['user_id'], unique=True)
    ...
    op.create_index(op.f('ix_behavioral_evolutions_id'), 'behavioral_evolutions', ['id'], unique=False)
    op.create_index(op.f('ix_behavioral_evolutions_user_id'), 'behavioral_evolutions', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_continuous_learnings_id'), 'continuous_learnings', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_learning_replays_id'), 'learning_replays', ['id'], unique=False)
    op.create_index(op.f('ix_learning_replays_session_id'), 'learning_replays', ['session_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_behavioral_evolutions_user_id'), table_name='behavioral_evolutions')
    op.drop_index(op.f('ix_behavioral_evolutions_id'), table_name='behavioral_evolutions')
    op.drop_table('behavioral_evolutions')
    
    op.drop_index(op.f('ix_financial_dna_profiles_user_id'), table_name='financial_dna_profiles')
    op.drop_index(op.f('ix_financial_dna_profiles_id'), table_name='financial_dna_profiles')
    op.drop_table('financial_dna_profiles')
    
    op.drop_index(op.f('ix_decision_predictions_user_id'), table_name='decision_predictions')
    op.drop_index(op.f('ix_decision_predictions_decision_id'), table_name='decision_predictions')
    op.drop_index(op.f('ix_decision_predictions_id'), table_name='decision_predictions')
    op.drop_table('decision_predictions')
    
    op.drop_index(op.f('ix_policy_decision_cache_decision_id'), table_name='policy_decision_cache')
    op.drop_index(op.f('ix_policy_decision_cache_id'), table_name='policy_decision_cache')
    op.drop_table('policy_decision_cache')
    
    op.drop_index(op.f('ix_adaptive_personalizations_user_id'), table_name='adaptive_personalizations')
    op.drop_index(op.f('ix_adaptive_personalizations_id'), table_name='adaptive_personalizations')
