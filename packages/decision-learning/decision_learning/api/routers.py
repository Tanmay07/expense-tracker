...
from ..domain.models import (
    DecisionMemoryCreate, DecisionMemoryResponse,
    PatternCreate, PatternResponse,
    PersonalizationCreate, PersonalizationResponse,
    PolicyCacheCreate, PolicyCacheResponse,
...
from ..application.services import (
    DecisionMemoryService, PatternMiningService, PersonalizationService,
    PolicyDecisionCacheService, SuccessPredictionService, FinancialDNAService,
    BehaviorEvolutionService, ContinuousLearningService, LearningReplayService
)
...
def update_personalization(user_id: str, data: PersonalizationCreate, db: Session = Depends(get_db)):
