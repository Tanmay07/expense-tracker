...
class RecommendationService:
    def generate_recommendations(
        self, user_id: str, health: HealthScore
    ) -> List[Recommendation]:
        recs = []
...
class BillService:
    ...
    def add_bill(
        self, user_id: str, biller_name: str, amount: float, due_date: datetime
    ) -> Bill:
        bill = Bill(
            user_id=user_id, biller_name=biller_name, amount=amount, due_date=due_date
        )
...
class RecurringService:
    ...
    def setup_recurring(
        self, user_id: str, name: str, amount: float, tx_type: str, rrule: str
    ) -> RecurringTransaction:
...
class ReminderService:
    ...
    def create_reminder(
        self, user_id: str, title: str, message: str, trigger_date: datetime
    ) -> Reminder:
        rem = Reminder(
            user_id=user_id, title=title, message=message, trigger_date=trigger_date
        )
