...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_gov_trust_scores_asset_id"),
        "gov_trust_scores",
        ["asset_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_gov_maturity_records_asset_id"),
        "gov_maturity_records",
        ["asset_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_gov_ai_metrics_asset_id"), "gov_ai_metrics", ["asset_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["previous_ledger_id"],
            ["gov_evidence_ledger.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_gov_evidence_ledger_asset_id"),
        "gov_evidence_ledger",
        ["asset_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_gov_workflows_asset_id"), "gov_workflows", ["asset_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_gov_evidence_ledger_asset_id"), table_name="gov_evidence_ledger"
    )
    ...
    op.drop_index(
        op.f("ix_gov_maturity_records_asset_id"), table_name="gov_maturity_records"
    )
