...
class CredentialManager(ABC):
    ...
    @abstractmethod
    async def store_credentials(self, connection_id: str, credentials: Dict[str, Any]) -> bool:
        pass

    @abstractmethod
    async def retrieve_credentials(self, connection_id: str) -> Optional[Dict[str, Any]]:
        pass
...
class AuthenticationService:
    ...
    async def exchange_oauth_code(self, connection_id: str, provider_id: str, auth_code: str) -> bool:
        """
        ...
        return await self.credential_manager.store_credentials(connection_id, credentials)

    async def get_valid_credentials(self, connection_id: str) -> Optional[Dict[str, Any]]:
        """
