...
class FeatureFlagModel(Base):
    ...
    id = Column(String, primary_key=True)
    feature_id = Column(String, ForeignKey("exp_features.id"), nullable=False, index=True)
...
class ExperimentModel(Base):
    ...
    status = Column(String, nullable=False, default="DRAFT") # DRAFT, RUNNING, PAUSED, COMPLETED
...
class ExperimentResultModel(Base):
    ...
    id = Column(String, primary_key=True)
    experiment_id = Column(String, ForeignKey("exp_experiments.id"), nullable=False, index=True)
