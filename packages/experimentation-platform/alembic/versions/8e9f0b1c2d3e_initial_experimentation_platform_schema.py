...
def upgrade() -> None:
    ...
    op.create_table('exp_feature_flags',
        sa.Column('id', sa.String(), nullable=False),
        ...
        sa.Column('targeting_rules_json', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['feature_id'], ['exp_features.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_exp_feature_flags_feature_id'), 'exp_feature_flags', ['feature_id'], unique=False)

    op.create_table('exp_rollouts',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('feature_id', sa.String(), nullable=False),
        sa.Column('current_stage', sa.String(), nullable=False),
        sa.Column('stage_metadata_json', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index(op.f('ix_exp_rollouts_feature_id'), 'exp_rollouts', ['feature_id'], unique=False)

    op.create_table('exp_experiments',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('name', sa.String(), nullable=False),
    ...
    op.create_table('exp_experiment_results',
        sa.Column('id', sa.String(), nullable=False),
        ...
        sa.ForeignKeyConstraint(['experiment_id'], ['exp_experiments.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_exp_experiment_results_experiment_id'), 'exp_experiment_results', ['experiment_id'], unique=False)

def downgrade() -> None:
    op.drop_index(op.f('ix_exp_experiment_results_experiment_id'), table_name='exp_experiment_results')
    ...
    op.drop_index(op.f('ix_exp_feature_flags_feature_id'), table_name='exp_feature_flags')
