...
def test_semantic_foundation_glossary_and_metadata():
    ...
    res1 = client.post("/api/v1/semantic/glossary", json={
    ...
    res2 = client.post("/api/v1/semantic/metadata/tag", json={
    ...
    res3 = client.get("/api/v1/semantic/glossary/term_liquid_net_worth", headers=headers)
    assert res3.status_code == 200
    assert res3.json()["business_name"] == "Liquid Net Worth"
    
    res4 = client.get("/api/v1/semantic/metadata/term_liquid_net_worth", headers=headers)
