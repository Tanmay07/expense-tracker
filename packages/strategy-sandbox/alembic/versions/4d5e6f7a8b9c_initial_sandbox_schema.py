...
def upgrade() -> None:
    op.create_table('sandbox_validation_profiles',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('name', sa.String(), nullable=False),
        sa.Column('profile_type', sa.String(), nullable=False),
        sa.Column('required_stages', sa.ARRAY(sa.String()), nullable=False),
        sa.Column('pass_criteria_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column('failure_thresholds_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column('scoring_weights_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    op.create_table('sandbox_runs',
        ...
        sa.Column('stage_results_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column('started_at', sa.DateTime(), nullable=True),
        sa.Column('completed_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['profile_id'], ['sandbox_validation_profiles.id'], ),
        sa.PrimaryKeyConstraint('id')
    )

    op.create_table('sandbox_fitness_scores',
        sa.Column('id', sa.String(), nullable=False),
    ...
    op.create_table('sandbox_benchmarks',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('run_id', sa.String(), nullable=False),
        sa.Column('benchmark_type', sa.String(), nullable=False),
        sa.Column('reference_id', sa.String(), nullable=True),
        sa.Column('regression_report_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column('improvement_analysis_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.ForeignKeyConstraint(['run_id'], ['sandbox_runs.id'], ),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('run_id')
    )

    op.create_table('sandbox_prompt_validations',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('run_id', sa.String(), nullable=False),
    ...
    op.create_table('sandbox_replay_snapshots',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('run_id', sa.String(), nullable=False),
        sa.Column('input_snapshot_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column('timeline_snapshot_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column('knowledge_graph_snapshot_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        ...
        sa.Column('validation_configuration_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.ForeignKeyConstraint(['run_id'], ['sandbox_runs.id'], ),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('run_id')
    )

    op.create_table('sandbox_certifications',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('run_id', sa.String(), nullable=False),
        sa.Column('asset_id', sa.String(), nullable=False),
        ...
        sa.Column('review_schedule_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.ForeignKeyConstraint(['run_id'], ['sandbox_runs.id'], ),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('run_id')
    )
