...
from wealth_management.domain.models import (
    WealthProfile,
    Portfolio,
    Holding,
...
class PortfolioService:
    ...
    def create_portfolio(self, user_id: str, name: str, broker: str) -> Portfolio:
        ...
        portfolio = Portfolio(
            user_id=user_id, wealth_profile_id=profile.id, name=name, broker=broker
        )
...
class HoldingService:
    ...
    def get_or_create_holding(
        self, portfolio_id: str, asset_symbol: str, asset_class: str
    ) -> Holding:
...
class InvestmentTransactionService:
    ...
    def execute_buy(
        ...
        # Update holding
        holding = self.holding_svc.get_or_create_holding(
            portfolio_id, asset_symbol, asset_class
        )
