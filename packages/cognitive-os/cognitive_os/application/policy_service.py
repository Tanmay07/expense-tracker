...
class PolicyAwareReasoningService:
    ...
    def validate_recommendation(self, agent_role: str, recommendation: str, context: Dict[str, Any]) -> PolicyValidationResult:
        """
        ...
        if context.get("portfolio_volatility", 0) > 0.3 and "buy options" in recommendation.lower():
            violations.append(PolicyViolation(
