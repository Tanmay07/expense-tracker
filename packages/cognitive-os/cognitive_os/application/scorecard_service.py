...
class CognitiveScorecardService:
    ...
    def record_metrics(
        self, user_id: str, metrics_update: Dict[str, Any]
    ) -> ScorecardMetrics:
        """
        ...
        current = ScorecardMetrics(
            ...
            financial_improvement_usd=metrics_update.get(
                "financial_improvement_usd", 0.0
            ),
            recommendation_acceptance_rate=metrics_update.get(
            ...
            avg_reasoning_latency_ms=metrics_update.get(
