...
def upgrade() -> None:
    ...
    op.create_table('knowledge_capability_matrix',
        sa.Column('id', sa.String(), nullable=False),
        ...
        sa.Column('purge_rules_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        ...
        sa.Column('ai_usability_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column('updated_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['asset_id'], ['marketplace_assets.id'], ),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('asset_id')
    )

    op.create_table('asset_certifications',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('asset_id', sa.String(), nullable=False),
        sa.Column('status', sa.String(), nullable=False),
        sa.Column('certifier_id', sa.String(), nullable=True),
        sa.Column('certification_tier', sa.String(), nullable=True),
        sa.Column('compliance_metadata_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column('security_metadata_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    op.create_table('asset_rankings',
        sa.Column('id', sa.String(), nullable=False),
        sa.Column('asset_id', sa.String(), nullable=False),
