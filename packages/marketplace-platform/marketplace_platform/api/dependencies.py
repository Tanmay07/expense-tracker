...
from marketplace_platform.infrastructure.repositories import (
    MarketplaceAssetRepository,
    KnowledgeCapabilityMatrixRepository,
    CertificationRepository,
    AssetRankingRepository,
)
from marketplace_platform.application.services import (
    MarketplaceService,
    KnowledgeCapabilityMatrixService,
    GovernanceService,
    RankingService,
...
def get_capability_service(
    repo: KnowledgeCapabilityMatrixRepository = Depends(get_capability_repo),
) -> KnowledgeCapabilityMatrixService:
...
def get_certification_service(
    cert_repo: CertificationRepository = Depends(get_certification_repo),
) -> CertificationService:
