...
def freeze_documentation(
    version: str, repo: ReleaseRepository = Depends(get_repository)
):
...
def generate_release(
    ...
    return svc.generate_release_manifest(
        version, certification_id, baseline_id, contract_matrix_id, doc_index_id
    )
