    ...
    async def get_dashboard_data(self, user_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "upcoming_actions": [
                {
                    "id": "A1",
                    "title": "Approve Tax Loss Harvesting Strategy",
                    "urgency": "HIGH",
                },
                {
                    "id": "A2",
                    "title": "Review AI Monthly Insights",
                    "urgency": "MEDIUM",
                },
            ],
            ...
            "today_insights": [
                {
                    "type": "OPPORTUNITY",
                    "message": "Interest rates dropped. Refinancing your mortgage could save $200/mo.",
                }
            ],
        }
    ...
    async def get_timeline_feed(self, user_id: str) -> list:
        return [
            ...
            },
            {
                ...
                "description": "AI executed auto-rebalance",
                "impact": "Positive",
            },
            {
                "id": "T3",
