...
class FinancialObservabilityService:
    ...
    def track_financial_event(self, source: str, event_data: Dict[str, Any]) -> TelemetryEvent:
        dto = TelemetryEventCreate(
            category="FINANCIAL",
            source=source,
            payload=event_data
...
class OperationalIntelligenceService:
    ...
    def analyze_anomaly(self, title: str, severity: str, details: Dict[str, Any]) -> Incident:
        """
...
class SLOService:
    ...
    def register_slo(self, service_name: str, slo_name: str, target: float) -> SLORecord:
        slo = SLORecord(
...
class DashboardService:
    ...
    def create_dashboard(self, name: str, owner_id: str, layout: Dict[str, Any]) -> DashboardConfig:
